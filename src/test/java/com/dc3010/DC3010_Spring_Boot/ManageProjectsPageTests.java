...
public class ManageProjectsPageTests {
    ...
    private MockMvc mockMvc;
	 ...
	 void testDoGet() throws Exception {
		 ...
		 MvcResult mvcResult = mockMvc.perform(get("/manage"))
	               .andExpect(status().isOk())
	               .andExpect(view().name("manageproject.html"))
	               .andExpect(model().attributeExists("toolRecords"))
	               .andReturn();
	    ...
	    void testCreateProjectSuccess() throws Exception {
	        ...
	        mockMvc.perform(post("/create/project")
	                                              .param("client-name", "UnitClient")
	                                              .param("project-name", "UnitProject")
	                                              .param("project-grade", "A5")
	                                              .param("start-date", "2023-07-20")
	                                              .param("end-date", "2023-07-25")
	                                              .param("work-location", "Remote")
	                                              .param("general-description", "Unit Test Description")
	                                              .param("tools-used", toolsUsed))
	    ...
	    void testCreateProjectSuccessClientSite() throws Exception {
	        ...
	        mockMvc.perform(post("/create/project")
	                                              ...
	                                              .param("start-date", "2023-07-20")
	                                              .param("end-date", "2023-07-25")
	                                              .param("work-location", "Client_Site")
	                                              .param("address", "This is a unit test address")
	                                              .param("general-description", "Unit Test Description")
	                                              .param("tools-used", toolsUsed))
	               .andExpect(status().is3xxRedirection())
	               .andExpect(redirectedUrl("/manage"))
	    ...
	    void testCreateProjectFailEndDateBeforeStartDate() throws Exception {
	        ...
	        mockMvc.perform(post("/create/project")
	                                              .param("client-name", "ClientName")
	                                              .param("project-name", "ProjectName")
	                                              .param("project-grade", "Grade")
	                                              .param("start-date", "2023-07-25")
	                                              .param("end-date", "2023-07-20")
	                                              .param("work-location", "Remote")
	                                              .param("general-description", "Description")
	                                              .param("tools-used", toolsUsed))
	               .andExpect(status().is3xxRedirection())
	               .andExpect(redirectedUrl("/manage"))
